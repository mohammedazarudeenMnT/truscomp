...
export function WhyChooseSection({ reasons = [], title = "Why Choose Us", subtitle }: WhyChooseSectionProps) {
                    ...
                    {reasons.map((reason, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-linear-to-br from-primary/5 via-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                                {/* Corner decorators with enhanced animation */}
