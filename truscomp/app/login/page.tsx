      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-base-50">
        <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="max-w-xl space-y-8 z-10">
                <div className="h-20 w-40 relative mb-8">
                     <Image
                ...
                <p className="text-lg text-base-600 leading-relaxed">
                    TrusComp is your dedicated partner in navigating the complex landscape of statutory compliance in India.
                </p>
                
                <div className="grid grid-cols-2 gap-6 pt-8">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-base-200">
                        <h3 className="font-semibold text-lg text-primary-600 mb-2">100%</h3>
                        <p className="text-sm text-base-600">Compliance accuracy with automated tools</p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-base-200">
                        <h3 className="font-semibold text-lg text-primary-600 mb-2">24/7</h3>
                        <p className="text-sm text-base-600">Expert support for your compliance needs</p>
                    </div>
                </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <Label htmlFor="password" className="text-base-700 font-medium">
